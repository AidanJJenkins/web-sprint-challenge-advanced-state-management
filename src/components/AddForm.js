...
import {addSmurfs, gotError } from '../actions';
...
const AddForm = (props) => {
    ...
    const handleSubmit = e => {
        ...
        if (state.name === "" || state.position === "" || state.nickname === "") {
            props.gotError("Name, position and nickname fields are required.");
...
export default connect(mapStateToProps, {addSmurfs,gotError}) (AddForm);
